...
class Label extends \Magento\Backend\Block\Widget\Grid\Extended {
    /**
    ...
    public function getRowClickCallback()
    {
        $js = "
            function (grid, event) {
                ...
                var input = $('products_using_label');
                if (trElement) {
    ...
    public function getRowInitCallback(){
        $js =' function (grid, row) {
            if($$(".input-text.admin__control-text.no-changes")[3].value!=""||
                        $$(".input-text.admin__control-text.no-changes")[4].value!="" ||
                        $$(".input-text.admin__control-text.no-changes")[5].value!=""||
                        $$(".no-changes.admin__control-select")[4].value!="" ||
                        $$(".no-changes.admin__control-select")[5].value!=""){
                                 $$(".action-default")[9].show();
                                  $$(".no-changes.admin__control-select")[0].show();
                        }
                        else{
                            $$(".action-default")[9].hide();
                            $$(".no-changes.admin__control-select")[0].hide();
                        }
                grid.reloadParams["selected[]"] = $("products_using_label").value.split(", ");
        } ';
        return $js;
    }
