 ...
 * Action ExportXml
 */
class ExportXml extends \Magestore\Megamenu\Controller\Adminhtml\Megamenu
{
    /**
     * Execute action
     */
    public function execute()
    {
        ...
        $content = $resultPage->getLayout()->createBlock('Magestore\Megamenu\Block\Adminhtml\Megamenu\Grid')->getXml();
