 ...
 * Action ExportExcel
 */
class ExportExcel extends \Magestore\Megamenu\Controller\Adminhtml\Megamenu
{
    /**
     * Execute action
     */
    ...
    {
        $fileName = 'Megamenus.xls';

        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->resultFactory->create(ResultFactory::TYPE_PAGE);
        $content = $resultPage->getLayout()->createBlock('Magestore\Megamenu\Block\Adminhtml\Megamenu\Grid')->getExcel();
